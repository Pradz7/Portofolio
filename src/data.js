...
import Proyek1 from "/assets/project/proyek1.jpg";
import Proyek2 from "/assets/project/proyek2.jpg";
import Proyek3 from "/assets/project/proyek3.jpg";
import Proyek4 from "/assets/project/proyek4.jpg";
import Proyek5 from "/assets/project/proyek5.jpg";
...
export const listProyek = [
  ...
  },
  {
    ...
    subtitle: "Library System is a web-based library management application...",
    fullDescription:"Library System is a web-based library management application developed to help manage books, users, borrowing activities, and library data more efficiently. Built using Laravel, PHP, Blade, JavaScript, CSS, and MySQL, this project provides features for organizing book collections, handling user interactions, and supporting a more structured digital library workflow. This project demonstrates my ability to build full-stack web applications with database integration, CRUD functionality, and responsive user interfaces.",
    borderColor: "#3B82F6",
    gradient: "linear-gradient(145deg, #3B82F6, #000)",
    url: "https://github.com/Pradz7/Library_System",
    dad: "300",
  },
  {
    id: 4,
    ...
    fullDescription:"Lumina AI is a Flask-based AI image editing web application built with Python, HTML, CSS, and JavaScript. It provides AI-assisted tools such as background removal, beautify, color correction, object removal using brush mask and LaMa inpainting, and style transfer. This project demonstrates my ability to integrate AI features into a functional web application while focusing on image processing, user interaction, and practical photo editing workflows.",
    borderColor: "#3B82F6",
    gradient: "linear-gradient(145deg, #3B82F6, #000)",
